...
::: activity
title: "R Markdown Practice" <br> subtitle: "Activity 01" <br> author: "Willie Wildcat" <br> date: "2022-09-23" <br> format: html
:::
...
::: task
Task 6 <br> message: false is 'Challenge'
:::
...
::: {.column width="40%"}
::: {style="opacity:0.75}
![](images/images_horst/horst_rstudio_air.png){height="1in"} <br> <small> Artwork by \@allison_horst </small>
:::
:::
:::
:::
