...
::: {.column width="40%"}
::: {style="opacity:0.75}
![](images/images_horst/ggplot2_masterpiece.png){height="1in"} <br> <small> Artwork by \@allison_horst </small>
:::
:::
:::
:::
...
![](images/images_lecture/fig_03facet.png){#id .class width="800px" height="600px"}
:::
